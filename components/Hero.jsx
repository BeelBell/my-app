            ...
            <div className='items-center justify-center text-left flex max-w-[1640px] mx-auto p-4 py-12 '>
                <div class="w-full p-4 bg-white items-center sm:p-8">
                    <div class="flex items-center justify-center mb-4">
                        <h1 className='text-5xl font-medium text-transparent md:text-8xl bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-500'>
                            YaJok Group
                        </h1>

                    </div>
                    <div className='text-base md:text-xl flex items-center justify-center mb-4'>
                        <span>
